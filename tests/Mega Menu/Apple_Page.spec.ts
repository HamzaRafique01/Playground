...
test.describe('Verify Mega Menu > Apple Page All snerio', () => {
  ...
  test.skip('Verify Mega Menu Navigation to Apple Page', async ({ page }) => {
  ...
  test.skip('Verify URL of Apple Page', async ({ page }) => {
  ...
  test.skip('Check the current page name', async ({ page }) => {
    ...
    try {
      ...
      // Verify page Name 
      await apple_Page.verifypagename(pagename);
  ...
  test.skip('Check the Page Title', async ({ page }) => {
  ...
  test.skip('Verify Main Banner image', async ({ page }) => {
  ...
  test.skip('Verify Presence of Apple Products', async ({ page }) => {
  ...
  test.skip('Verify Product Count', async ({ page }) => {
  ...
  test.skip('Verify Product Sorting Options', async ({ page }) => {
  ...
  test.skip('Set Minimum Price Range', async ({ page }) => {
  ...
  test.skip('Set Maximum Price Range', async ({ page }) => {
  ...
  test.skip('Products are listed correctly with , titles, and prices', async ({ page }) => {
  ...
  test.skip('Check that product images are loading and are of good quality', async ({ page }) => {
  ...
  test.skip('Check the each product title descriptive', async ({ page }) => {
  ...
  test.skip('The "Add to Cart" button works and adds the product to the cart', async ({ page }) => {
